...
class Scrapper
  ...
  def parse_quotes_frame
    change_endpoint(:frame)
    frame = browser.iframe(name: 'my_awesome_frame')
    parse_quote(frame.div(class: 'quote'))
  end
...
def run
  ...
  puts "Parsed random quote inside frame: #{!scrapper.parse_quotes_frame.empty?}"
